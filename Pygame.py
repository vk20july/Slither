...
icon=pygame.image.load("D:\Practice\Project\Slither\Apple.png")
...
#lets fill the color RGB format
white=(255,255,255)
black=(0,0,0)
red=(255,0,0)
green=(137,194,61)
...
img=pygame.image.load("D:\Practice\Project\Slither\SnakeFin20.png")
appleImg=pygame.image.load("D:\Practice\Project\Slither\Apple.png")
...
def game_intro(): 
    ...
    gameDisplay.fill(white)
    message_to_screen("Welocome to Slither",(0,155,0),-100,"large")
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
                ...
                if event.key==pygame.K_p:
                    pause()
            #ADDING THIS FEATURE WOULD make the movement only untill key is pressed.When key is unpressed, it make the variable 0,hence stops
            """
            ...
            """
            FEATURE SUCH THAT SCREEN KI EK SIDE SE JAAYE TO DUSRE SE NIKAL JAYE
            if lead_x==800:
                lead_x=0
            elif lead_x<0:
                lead_x=800
